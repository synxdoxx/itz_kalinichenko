...
class Game: #класс самой игры
    ...
    2. Нет''')
            ...
            if choice == 1:
                ...
                return self.game_active #Игра заканчивается
    ...
    def story(self):
        ...
        while self.game_active == True: #Здесь на протяжении всего цикла чередуется текст повествования и выборы для пользователя.
...
Точнее вообще никого нет. И едет она старнно.
